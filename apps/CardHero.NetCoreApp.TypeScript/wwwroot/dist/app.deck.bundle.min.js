...
/* harmony import */ var _DeckCreateModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DeckCreateModal */ "R3mS");
...
class DeckSearch extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DeckCreateModal__WEBPACK_IMPORTED_MODULE_2__["default"], { show: this.state.modalShown, onCreated: (deck) => this.onDeckCreated(deck), onHide: () => this.setState({ modalShown: false }) })));
    }
}
