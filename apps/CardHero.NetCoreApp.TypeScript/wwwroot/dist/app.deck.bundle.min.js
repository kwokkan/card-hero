                    ...
                    react_default.a.createElement("div", { className: "card" },
                        react_default.a.createElement("div", { className: "card-body" },
                            ...
                            react_default.a.createElement("div", { className: "card-text" },
                                react_default.a.createElement("ul", { id: "owned-cards", className: "ch-cards droppable" }, ownedCards && ownedCards.map(cc => react_default.a.createElement("li", { className: "ch-card draggable", "data-card-collection-id": cc.id }, cc.card.name))))))),
                react_default.a.createElement("div", { className: "col-lg-4" },
                    react_default.a.createElement("div", { className: "card" },
                        react_default.a.createElement("div", { className: "card-body" },
                            react_default.a.createElement("h4", { className: "card-title" }, "Current Deck"),
                            react_default.a.createElement("div", { className: "card-text" },
                                react_default.a.createElement("ul", { id: "used-cards", className: "ch-cards droppable", "data-max-cards": deck.maxCards }, usedCards && usedCards.map(cc => react_default.a.createElement("li", { className: "ch-card draggable", "data-card-collection-id": cc.cardCollectionId }, cc.name))))))))));
    }
}
