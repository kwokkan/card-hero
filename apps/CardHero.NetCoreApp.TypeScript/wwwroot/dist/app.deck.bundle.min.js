                    ...
                    react_default().createElement("div", { className: "card" },
                        react_default().createElement("div", { className: "card-body" },
                            ...
                            react_default().createElement("div", { className: "card-text" },
                                react_default().createElement("ul", { id: "owned-cards", className: "ch-cards droppable" }, ownedCards && ownedCards.map(cc => react_default().createElement("li", { key: cc.id, className: "ch-card draggable", "data-card-collection-id": cc.id }, cc.card.name))))))),
                react_default().createElement("div", { className: "col-lg-4" },
                    react_default().createElement("div", { className: "card" },
                        react_default().createElement("div", { className: "card-body" },
                            react_default().createElement("h4", { className: "card-title" }, "Current Deck"),
                            react_default().createElement("div", { className: "card-text" },
                                react_default().createElement("ul", { id: "used-cards", className: "ch-cards droppable", "data-max-cards": deck.maxCards }, usedCards && usedCards.map(cc => react_default().createElement("li", { key: cc.id, className: "ch-card draggable", "data-card-collection-id": cc.cardCollectionId }, cc.name))))))))));
    }
}
