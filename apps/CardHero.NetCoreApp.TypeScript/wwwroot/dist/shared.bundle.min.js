...
class NotificationWidget extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "notifications" }, notifications.map((x, index) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_NotificationItem__WEBPACK_IMPORTED_MODULE_2__[/* NotificationItem */ "a"], { key: index, message: x.message, title: x.title, type: x.type }))));
    }
}
...
class NotificationItem extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "notification-item alert" },
            this.props.title &&
