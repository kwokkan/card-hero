...
function CardCollectionCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: props.className, "data-card-collection-id": card.id }, card.card.name));
}
...
function CardCollectionWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-text ch-cards droppable" }, cardCollection.map(cc => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_CardCollectionCard__WEBPACK_IMPORTED_MODULE_1__[/* CardCollectionCard */ "a"], { key: cc.id, className: "ch-card draggable", card: cc }))))));
}
