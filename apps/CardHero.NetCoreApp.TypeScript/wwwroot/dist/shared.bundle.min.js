...
/* harmony export */ });
/* unused harmony exports UserModel, CardModel, CardPackModel, CardCollectionModel, GameModel, GamePlayModel, GameDeckModel, GameDeckCardCollectionModel, StoreItemModel */
...
function CardCollectionCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "list-group-item d-flex justify-content-between align-items-center", "data-card-collection-id": card.id },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null,
            card.card.name,
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "text-rarity_" + _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[card.card.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[card.card.rarity] }, Array(card.card.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles__WEBPACK_IMPORTED_MODULE_2__.Icon, { key: i, icon: "star" })))),
        props.actionName &&
