...
function CardCollectionWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
            props.title &&
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", { className: "card-title" }, props.title),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-text" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", { className: "ch-cards droppable" }, cardCollection.map(cc => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", { key: cc.id, className: "ch-card draggable", "data-card-collection-id": cc.id }, cc.card.name)))))));
}
