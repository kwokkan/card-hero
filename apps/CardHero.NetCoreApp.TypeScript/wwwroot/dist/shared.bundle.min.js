...
class CardService {
    static async getCards(filter) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* CardApiClient */ "b"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
...
class GameService {
    static async getGameById(id) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "f"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
...
class StoreService {
    static async getStoreItems() {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreApiClient */ "k"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
        const model = await client.get();
        return model;
    }
    static async buyCardBundle(id) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreApiClient */ "k"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreItemModel */ "l"]({
            id: id
        });
...
function CardWidget(props) {
    const c = props.card;
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: 'card collection-card card-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "j"][c.rarity].toLowerCase() },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-footer" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", { className: 'text-center card-rarity-symbols text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "j"][c.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "j"][c.rarity] }, Array(c.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__["Icon"], { key: i, icon: "star" }))),
...
class Layout extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ErrorBoundary__WEBPACK_IMPORTED_MODULE_2__[/* ErrorBoundary */ "a"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_contexts_AccountContext__WEBPACK_IMPORTED_MODULE_1__[/* AccountContext */ "a"].Provider, { value: this.state },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_NavMenu__WEBPACK_IMPORTED_MODULE_3__[/* NavMenu */ "a"], null),
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card mx-auto" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", { className: "card-text text-center" }, Array(_clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "j"].Legendary).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__["Icon"], { key: i, icon: "bug", className: 'text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "j"][i + 1].toLowerCase() }))),
...
/*! exports used: AccountApiClient, CardApiClient, CollectionApiClient, DeckApiClient, DeckModel, GameApiClient, GameCreateModel, GameTripleTriadMoveViewModel, GameType, Rarity, StoreApiClient, StoreItemModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(CardHeroApiClientBase) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AccountApiClient; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return StoreApiClient; });
/* unused harmony export UserModel */
/* unused harmony export ErrorViewModel */
/* unused harmony export CardModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return Rarity; });
/* unused harmony export CardCollectionModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return DeckModel; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return StoreItemModel; });
...
class AccountService {
    static async getAccount() {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* AccountApiClient */ "a"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
        const model = await client.get();
        return model;
    }
}
...
class CardCollectionService {
    static async getCollection(filter) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* CollectionApiClient */ "c"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
        if (!filter) {
            filter = {};
        }
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_0__[/* library */ "b"].add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__[/* faBug */ "a"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__[/* faCode */ "b"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__[/* faCoins */ "c"], _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_1__[/* faGithub */ "a"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__[/* faPlus */ "d"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__[/* faStar */ "e"]);
function Icon(props) {
    return (react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_3__[/* FontAwesomeIcon */ "a"], Object.assign({ icon: props.icon, fixedWidth: true }, props)));
}
...
class DeckService {
    static async getDecks(filter) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "d"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
        if (!filter) {
            filter = {};
        }
    ...
    static async createDeck(model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "d"](_components_shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_1__[/* AppBootstrap */ "a"].baseUrl);
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckModel */ "e"]();
...
class NavMenu extends react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
    ...
    render() {
        const u = _AppBootstrap__WEBPACK_IMPORTED_MODULE_4__[/* AppBootstrap */ "a"].url;
                        ...
                        (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", { className: "nav-item" },
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", { className: "nav-link" },
                                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_CoinFormat__WEBPACK_IMPORTED_MODULE_5__[/* CoinFormat */ "a"], { coins: user.coins, title: `You have ${user.coins} coins` }))),
...
NavMenu.contextType = _contexts_AccountContext__WEBPACK_IMPORTED_MODULE_1__[/* AccountContext */ "a"];
