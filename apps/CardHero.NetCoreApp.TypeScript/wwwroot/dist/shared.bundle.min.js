        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "container-fluid body-content" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "row" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card mx-auto" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card-footer" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: newIssueUrl.toString(), className: "btn btn-primary pull-right", target: "_blank" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.default, { icon: "github" }),
                            ' ',
                            "Report an issue"))))));
    }
}
...
class ErrorBoundary extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    ...
    render() {
        if (this.state.hasError) {
            return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ErrorView__WEBPACK_IMPORTED_MODULE_1__.ErrorView, { error: this.state.error, errorInfo: this.state.errorInfo });
        }
