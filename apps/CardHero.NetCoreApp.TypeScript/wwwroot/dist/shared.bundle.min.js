            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card mx-auto" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", { className: "card-text text-center" }, Array(_clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"].Legendary).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "bug", className: 'text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"][i + 1].toLowerCase() }))),
...
function CardCollectionCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "list-group-item d-flex justify-content-between align-items-center", "data-card-collection-id": card.id },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null,
            card.card.name,
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", { className: "text-rarity_" + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"][card.card.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"][card.card.rarity] }, Array(card.card.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "star" })))),
        props.actionName &&
...
class StoreService {
    static async getStoreItems() {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreApiClient */ "o"]();
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: AccountApiClient, CardApiClient, CardPackApiClient, CollectionApiClient, DeckApiClient, GameApiClient, StoreApiClient, UserModel, ErrorViewModel, CardModel, Rarity, CardPackModel, CardCollectionModel, DeckModel, DeckCardModel, DeckCreateModel, GameModel, GameUserModel, GameType, GameDeckModel, GameDeckCardCollectionModel, GameViewModel, GameDataViewModel, GameMoveViewModel, GameCreateModel, JoinGameViewModel, StoreItemModel, ApiException */
/*! exports used: AccountApiClient, CardApiClient, CardPackApiClient, CollectionApiClient, DeckApiClient, DeckCardModel, DeckCreateModel, DeckModel, GameApiClient, GameCreateModel, GameMoveViewModel, GameType, JoinGameViewModel, Rarity, StoreApiClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return StoreApiClient; });
/* unused harmony export UserModel */
/* unused harmony export ErrorViewModel */
/* unused harmony export CardModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return Rarity; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return GameType; });
/* unused harmony export GameDeckModel */
/* unused harmony export GameDeckCardCollectionModel */
/* unused harmony export GameViewModel */
/* unused harmony export GameDataViewModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return GameMoveViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return GameCreateModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return JoinGameViewModel; });
...
class GameService {
    ...
    static async join(id, deckId) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "i"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* JoinGameViewModel */ "m"]({
            deckId: deckId
        });
    ...
    static async move(id, model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "i"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameMoveViewModel */ "k"](model);
...
function CardWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: 'card collection-card card-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"][c.rarity].toLowerCase() },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-footer" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", { className: 'text-center card-rarity-symbols text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"][c.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "n"][c.rarity] }, Array(c.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "star" }))),
