...
function CardCollectionCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "list-group-item d-flex justify-content-between align-items-center", "data-card-collection-id": card.id },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null,
            card.card.name,
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "text-rarity_" + _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[rarity] }, Array(rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles__WEBPACK_IMPORTED_MODULE_2__.Icon, { key: i, icon: "star" })))),
        props.actionName &&
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { type: "button", className: actionClassName, disabled: props.actionDisabled, onClick: onActionClicked }, props.actionName)));
}
...
function CardCollectionWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card" },
        props.title &&
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: "card-header" }, props.title),
        props.subSection &&
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card-body" }, props.subSection),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "list-group list-group-flush" }, cardCollection.length > 0 ?
            (cardCollection.map(cc => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CardCollectionCard__WEBPACK_IMPORTED_MODULE_1__.CardCollectionCard, { key: cc.id, card: cc, actionName: props.cardActionName, onActionClicked: props.onCardClicked, actionDisabled: props.cardActionDisabled, actionClassName: props.cardActionClassName })))
            :
                (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "list-group-item" }, "No cards")))));
}
...
function CardWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: 'card collection-card card-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[rarity].toLowerCase() },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card-footer" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", { className: 'text-center card-rarity-symbols text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[rarity] }, Array(rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.Icon, { key: i, icon: "star" }))),
...
const coinRender = (className, value, stripEmpty) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "coin-group" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_1__.Icon, { icon: "coins", className: className }),
        ' ',
        value));
};
...
function DateFormat(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("time", { title: props.date.toUTCString(), dateTime: (0,_utils_date__WEBPACK_IMPORTED_MODULE_1__.toISOString)(props.date) }, d));
}
...
class ErrorBoundary extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    ...
    render() {
        if (this.state.hasError) {
            return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_ErrorView__WEBPACK_IMPORTED_MODULE_1__.ErrorView, { error: this.state.error, errorInfo: this.state.errorInfo, currentPage: this.state.currentPage });
        }
...
class ErrorView extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "container-fluid body-content" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "row" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card mx-auto" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", { className: "card-header" }, "Oops"),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card-body" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "card-text" }, "Looks like some bugs have managed to creep in."),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "card-text text-center" }, Array(_clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity.Legendary).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.Icon, { key: i, icon: "bug", className: 'text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__.Rarity[i + 1].toLowerCase() }))),
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card-text text-muted" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("details", null,
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("summary", null,
                                    e.name,
                                    ": ",
                                    e.message),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("pre", { id: "stacktrace" }, e.stack))),
                        ei &&
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "card-text text-muted" }, ei.componentStack)),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "card-footer" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: newIssueUrl.toString(), className: "btn btn-primary pull-right", target: "_blank", rel: "noreferrer noopener" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.Icon, { icon: "github" }),
                            ' ',
                            "Report an issue"))))));
    }
}
...
function InlineSearchBar({ value, onValueUpdated }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "input-group" },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "search", className: "form-control", placeholder: "Search", value: _value, onChange: onChange, onKeyUp: onKeyUp }),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "input-group-append" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { type: "button", className: "btn btn-primary", onClick: _onValueUpdated }, "Search"))));
}
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav", { className: "navbar navbar-dark bg-dark navbar-expand-md fixed-top" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: "navbar-toggler navbar-toggler-right", type: "button", "data-toggle": "collapse", "data-target": "#navbar-header", "aria-controls": "navbar-header", "aria-expanded": "false", "aria-label": "Toggle navigation" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.Icon, { icon: "bars" })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { to: routePrefix, className: "navbar-brand" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: `${routePrefix}favicon.ico`, className: "d-inline-block align-top", width: "32", height: "32", alt: appName }),
                ' ',
                appName),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "collapse navbar-collapse", id: "navbar-header" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", { className: "navbar-nav" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { className: "nav-link", to: `${routePrefix}Card` }, "Cards")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { className: "nav-link", to: `${routePrefix}Game` }, "Games")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { className: "nav-link", to: `${routePrefix}Store` }, "Store")),
                    user &&
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { className: "nav-link", to: `${routePrefix}Collection` }, "Collection")),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_3__.Link, { className: "nav-link", to: `${routePrefix}Deck` }, "Decks")))),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", { className: "navbar-nav ml-auto" },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: "nav-link", href: "https://github.com/kwokkan/card-hero", target: "_blank", rel: "noreferrer noopener" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.Icon, { icon: "github" }),
                            ' ',
                            "Fork me")),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: "nav-link", href: `${routePrefix}swagger`, target: "_blank", rel: "noreferrer noopener" },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__.Icon, { icon: "code" }),
                            ' ',
                            "API")),
                    user ?
                        (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "navbar-text" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_CoinFormat__WEBPACK_IMPORTED_MODULE_4__.CoinFormat, { coins: user.coins, title: `You have ${user.coins} coins` })),
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item dropdown" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "nav-link dropdown-toggle", id: "user-navbar-dropdown-menu", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, user.fullName),
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "dropdown-menu dropdown-menu-right", "aria-labelledby": "user-navbar-dropdown-menu" },
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "dropdown-item" }, "Profile"),
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "dropdown-item" }, "Active Games"),
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "dropdown-divider" }),
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "dropdown-item" }, "Settings"),
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "dropdown-divider" }),
                                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: "dropdown-item", href: `${routePrefix}SignOut` }, "Logout")))))
                        :
                            (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { className: "nav-item" },
                                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { className: "nav-link", href: `${routePrefix}SignIn` }, "Sign in")))))));
    }
}
...
class NotificationItem extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "notification-item toast fade show" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "toast-header" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "badge badge-pill badge-secondary mr-2 " + typeClass }, "\u00A0"),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", { className: "mr-auto" }, this.props.title),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { type: "button", className: "ml-2 mb-1 close", "aria-label": "Close", onClick: () => this.props.onDismiss() },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { "aria-hidden": "true" }, "\u00D7"))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", { className: "toast-body" }, this.props.message)));
    }
}
...
class NotificationWidget extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    render() {
        ...
        return (notifications.length > 0 &&
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "notifications mr-3" }, notifications.map((x, index) => react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_NotificationItem__WEBPACK_IMPORTED_MODULE_1__.NotificationItem, { key: index, message: x.message, title: x.title, type: x.type, onDismiss: () => onRemove(x) }))));
    }
}
...
function NumberDropDown(props) {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("select", { name: props.name, className: "form-control", value: props.value, onChange: props.onChange },
...
function AccountContextProvider(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_AccountContext__WEBPACK_IMPORTED_MODULE_1__.AccountContext.Provider, { value: contextProps, children: props.children }));
}
...
function NotificationContextProvider(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_NotificationContext__WEBPACK_IMPORTED_MODULE_1__.NotificationContext.Provider, { value: contextProps, children: props.children }));
}
...
function Icon(props) {
    return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_1__.FontAwesomeIcon, Object.assign({ icon: props.icon, fixedWidth: true }, props)));
}
