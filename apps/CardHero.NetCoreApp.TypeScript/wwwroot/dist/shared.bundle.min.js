            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card mx-auto" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", { className: "card-text text-center" }, Array(_clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"].Legendary).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "bug", className: 'text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"][i + 1].toLowerCase() }))),
...
function CardCollectionCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "list-group-item d-flex justify-content-between align-items-center", "data-card-collection-id": card.id },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null,
            card.card.name,
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", { className: "text-rarity_" + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"][card.card.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"][card.card.rarity] }, Array(card.card.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "star" })))),
        props.actionName &&
...
class DeckService {
    static favouriteCard(id, favourite) {
        ...
        const model = _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckModel */ "g"].fromJS(data);
    ...
    static async createDeck(model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "d"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckCreateModel */ "f"]();
    ...
    static async patchDeck(id, model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "d"]();
        var patchModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckModel */ "g"](model);
...
class StoreService {
    static async getStoreItems() {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreApiClient */ "n"]();
        const model = await client.get();
        return model;
    }
    static async buyCardBundle(id) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreApiClient */ "n"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreItemModel */ "o"]({
            id: id
        });
...
/*! exports used: AccountApiClient, CardApiClient, CollectionApiClient, DeckApiClient, DeckCardModel, DeckCreateModel, DeckModel, GameApiClient, GameCreateModel, GameTripleTriadMoveViewModel, GameType, JoinGameViewModel, Rarity, StoreApiClient, StoreItemModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* unused harmony export CardPackApiClient */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return GameApiClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return StoreApiClient; });
/* unused harmony export UserModel */
/* unused harmony export ErrorViewModel */
/* unused harmony export CardModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return Rarity; });
/* unused harmony export CardPackModel */
/* unused harmony export CardCollectionModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return DeckModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return DeckCardModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return DeckCreateModel; });
/* unused harmony export GameModel */
/* unused harmony export GameUserModel */
/* unused harmony export TurnModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return GameType; });
/* unused harmony export GameDeckModel */
/* unused harmony export GameDeckCardCollectionModel */
/* unused harmony export GameViewModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return GameCreateModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return JoinGameViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return GameTripleTriadMoveViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return StoreItemModel; });
...
class GameService {
    static async getGameById(id) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "h"]();
        const model = await client.getById(id);
        return model;
    }
    ...
    static async join(id, deckId) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "h"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* JoinGameViewModel */ "l"]({
            deckId: deckId
        });
...
function CardWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: 'card collection-card card-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"][c.rarity].toLowerCase() },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-footer" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", { className: 'text-center card-rarity-symbols text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"][c.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "m"][c.rarity] }, Array(c.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "star" }))),
