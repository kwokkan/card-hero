...
class CardCollectionModel {
    from(o) {
        if (!o)
            return this;
        this.id = o.id;
        this.card = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__["CardModel"]();
        if (o.card) {
...
class DeckCardModel extends _clients_clients__WEBPACK_IMPORTED_MODULE_0__["CardModel"] {
    constructor() {
        super(...arguments);
        this.isUsable = true;
    }
