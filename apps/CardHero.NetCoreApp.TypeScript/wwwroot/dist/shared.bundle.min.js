...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: AccountApiClient, CardApiClient, CardPackApiClient, CollectionApiClient, DeckApiClient, GameApiClient, StoreApiClient, UserModel, ErrorViewModel, CardModel, Rarity, CardPackModel, CardCollectionModel, DeckModel, DeckCardModel, DeckCreateModel, GameModel, GameType, GamePlayModel, MoveModel, GameDeckModel, GameDeckCardCollectionModel, GameCreateModel, GameJoinModel, StoreItemModel, ApiException */
/*! exports used: AccountApiClient, CardApiClient, CardPackApiClient, CollectionApiClient, DeckApiClient, DeckCardModel, DeckCreateModel, DeckModel, GameApiClient, GameCreateModel, GameJoinModel, GameType, MoveModel, Rarity, StoreApiClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return MoveModel; });
...
class GameService {
    ...
    static async move(id, model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "i"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* MoveModel */ "m"](model);
