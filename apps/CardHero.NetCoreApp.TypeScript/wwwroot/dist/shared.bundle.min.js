...
/*! export GameDataViewModel [provided] [unused] [could be renamed] */
...
/*! export GameMoveViewModel [provided] [used] [could be renamed] */
/*! export GameType [provided] [used] [could be renamed] */
/*! export GameUserModel [provided] [unused] [could be renamed] */
/*! export GameViewModel [provided] [unused] [could be renamed] */
/*! export JoinGameViewModel [provided] [used] [could be renamed] */
...
/*! export TurnModel [provided] [unused] [could be renamed] */
/*! export UserModel [provided] [unused] [could be renamed] */
/*! other exports [not provided] [unused] */
/*! runtime requirements: __webpack_exports__, __webpack_require__.d, __webpack_require__, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "GameMoveViewModel": () => /* binding */ GameMoveViewModel,
/* harmony export */   "GameCreateModel": () => /* binding */ GameCreateModel,
/* harmony export */   "JoinGameViewModel": () => /* binding */ JoinGameViewModel
/* harmony export */ });
/* unused harmony exports UserModel, ErrorViewModel, CardModel, CardPackModel, CardCollectionModel, GameModel, GameUserModel, TurnModel, GameDeckModel, GameDeckCardCollectionModel, GameViewModel, GameDataViewModel, StoreItemModel, ApiException */
...
class GameViewModel extends GameModel {
    ...
    init(_data) {
        super.init(_data);
        if (_data) {
            this.data = _data["data"] ? GameDataViewModel.fromJS(_data["data"]) : undefined;
...
class GameService {
    ...
    static async join(id, deckId) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__.GameApiClient();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__.JoinGameViewModel({
            deckId: deckId
        });
    ...
    static async move(id, model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__.GameApiClient();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__.GameMoveViewModel(model);
