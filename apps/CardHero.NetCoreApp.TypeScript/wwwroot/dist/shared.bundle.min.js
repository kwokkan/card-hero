...
class CardPackService {
    static async getCardPacks() {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* CardPackApiClient */ "c"]();
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card mx-auto" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
                        ...
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", { className: "card-text text-center" }, Array(_clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"].Legendary).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "bug", className: 'text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"][i + 1].toLowerCase() }))),
...
function CardCollectionCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "list-group-item d-flex justify-content-between align-items-center", "data-card-collection-id": card.id },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null,
            card.card.name,
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", { className: "text-rarity_" + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"][card.card.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"][card.card.rarity] }, Array(card.card.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "star" })))),
        props.actionName &&
...
class DeckService {
    static favouriteCard(id, favourite) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "e"]();
        const data = {
            isFavourited: favourite
        };
        const model = _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckModel */ "h"].fromJS(data);
    ...
    static async createDeck(model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "e"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckCreateModel */ "g"]();
    ...
    static async patchDeck(id, model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckApiClient */ "e"]();
        var patchModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* DeckModel */ "h"](model);
...
/* harmony import */ var _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fortawesome/fontawesome-svg-core */ "N80I");
/* harmony import */ var _fortawesome_free_brands_svg_icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fortawesome/free-brands-svg-icons */ "ORgc");
/* harmony import */ var _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fortawesome/free-solid-svg-icons */ "nIvZ");
/* harmony import */ var _fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fortawesome/react-fontawesome */ "eRca");
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! chart.js */ "yScH");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react */ "GeX+");
...
class StoreService {
    static async getStoreItems() {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* StoreApiClient */ "p"]();
...
class GamePlayService {
    static async getGamePlayById(id) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GamePlayApiClient */ "l"]();
        const model = await client.getById(id);
        return model;
    }
    static async move(id, model) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GamePlayApiClient */ "l"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* MoveModel */ "n"](model);
...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "IPhX");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var dayjs_plugin_relativeTime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dayjs/plugin/relativeTime */ "jRx3");
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: AccountApiClient, CardApiClient, CardPackApiClient, CollectionApiClient, DeckApiClient, GameApiClient, GamePlayApiClient, StoreApiClient, UserModel, ErrorViewModel, CardModel, Rarity, CardPackModel, CardCollectionModel, DeckModel, DeckCardModel, DeckCreateModel, GameModel, GameType, GameCreateModel, GameJoinModel, GamePlayModel, MoveModel, GameDeckModel, GameDeckCardCollectionModel, StoreItemModel, ApiException */
/*! exports used: AccountApiClient, CardApiClient, CardPackApiClient, CollectionApiClient, DeckApiClient, DeckCardModel, DeckCreateModel, DeckModel, GameApiClient, GameCreateModel, GameJoinModel, GamePlayApiClient, GameType, MoveModel, Rarity, StoreApiClient */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return CardPackApiClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return CollectionApiClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return DeckApiClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return GameApiClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return GamePlayApiClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return StoreApiClient; });
/* unused harmony export UserModel */
/* unused harmony export ErrorViewModel */
/* unused harmony export CardModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return Rarity; });
/* unused harmony export CardPackModel */
/* unused harmony export CardCollectionModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return DeckModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return DeckCardModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return DeckCreateModel; });
/* unused harmony export GameModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return GameType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return GameCreateModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return GameJoinModel; });
/* unused harmony export GamePlayModel */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return MoveModel; });
...
/*! exports used: NotificationContextProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class CardCollectionService {
    static async getCollection(filter) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* CollectionApiClient */ "d"]();
        if (!filter) {
            filter = {};
        }
...
class GameService {
    static async getGameById(id) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "i"]();
        const model = await client.getById(id);
        return model;
    }
    ...
    static async join(id, deckId) {
        const client = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameApiClient */ "i"]();
        const postModel = new _clients_clients__WEBPACK_IMPORTED_MODULE_0__[/* GameJoinModel */ "k"]({
            deckId: deckId
        });
...
function CardWidget(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: 'card collection-card card-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"][c.rarity].toLowerCase() },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-footer" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", { className: 'text-center card-rarity-symbols text-rarity_' + _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"][c.rarity].toLowerCase(), title: _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* Rarity */ "o"][c.rarity] }, Array(c.rarity).fill(0).map((_, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_styles_index__WEBPACK_IMPORTED_MODULE_2__[/* Icon */ "a"], { key: i, icon: "star" }))),
...
class NotificationItem extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "notification-item alert alert-dismissible fade show " + typeClass },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { type: "button", className: "close", "data-dismiss": "alert", "aria-label": "Close", onClick: () => this.props.onDismiss() },
