...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StoreItemDetails; });
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-footer" },
            si.expiry &&
                (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_DateFormat__WEBPACK_IMPORTED_MODULE_2__["default"], { date: si.expiry }))),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { type: "button", className: "btn btn-primary pull-right", onClick: onSelectItem },
                "Buy for ",
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_CoinFormat__WEBPACK_IMPORTED_MODULE_1__["default"], { coins: si.cost, title: si.cost.toString(), stripEmpty: true })))));
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StoreItemBuyModal; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "q1tI");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StoreApp; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "q1tI");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
class StoreApp extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Store__WEBPACK_IMPORTED_MODULE_2__["default"], null)));
    }
}
...
/* harmony import */ var _shared_appBootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/appBootstrap */ "QBAw");
/* harmony import */ var _StoreApp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./StoreApp */ "YHU9");




react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_StoreApp__WEBPACK_IMPORTED_MODULE_3__["default"], null), _shared_appBootstrap__WEBPACK_IMPORTED_MODULE_2__["default"].rootElement);
...
/* harmony import */ var _services_StoreService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/StoreService */ "GAEF");
/* harmony import */ var _StoreItemBuyModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./StoreItemBuyModal */ "GQnm");
/* harmony import */ var _StoreItemDetails__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./StoreItemDetails */ "1sfg");
...
class Store extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    async componentDidMount() {
        const items = await _services_StoreService__WEBPACK_IMPORTED_MODULE_4__["default"].getStoreItems();
        this.setState({
            items: items
        });
    }
    ...
    async onPurchase(item) {
        const items = await _services_StoreService__WEBPACK_IMPORTED_MODULE_4__["default"].buyCardBundle(item.id);
        if (_constants_constants__WEBPACK_IMPORTED_MODULE_1__["default"].Debug) {
            console.log(items);
        }
        this.setState({
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" }, this.state.items.map(x => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { key: x.id, className: "col-lg-4" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_StoreItemDetails__WEBPACK_IMPORTED_MODULE_6__["default"], { storeItem: x, onSelectItem: (item) => this.onSelectItem(item) })))),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_StoreItemBuyModal__WEBPACK_IMPORTED_MODULE_5__["default"], { show: this.state.modalShown, onHide: () => this.onModalHide(), onPurchase: (item) => this.onPurchase(item), storeItem: this.state.selectedItem })));
    }
}
Store.contextType = _contexts_AccountContext__WEBPACK_IMPORTED_MODULE_2__["AccountContext"];
