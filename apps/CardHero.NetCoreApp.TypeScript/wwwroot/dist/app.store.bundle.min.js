    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" }, this.state.items.map(x => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { key: x.id, className: "col-lg-4" },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_StoreItemDetails__WEBPACK_IMPORTED_MODULE_5__["default"], { storeItem: x, onSelectItem: (item) => this.onSelectItem(item) })))),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_StoreItemBuyModal__WEBPACK_IMPORTED_MODULE_4__["default"], { show: this.state.modalShown, onHide: () => this.onModalHide(), onPurchase: (item) => this.onPurchase(item), storeItem: this.state.selectedItem })));
    }
}
