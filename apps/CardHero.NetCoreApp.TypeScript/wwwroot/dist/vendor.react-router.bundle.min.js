...
/*! export Route [provided] [used in runtime] [could be renamed] */
/*! export Router [provided] [used in runtime] [could be renamed] */
/*! export StaticRouter [provided] [unused] [could be renamed] */
/*! export Switch [provided] [used in runtime] [could be renamed] */
/*! export __HistoryContext [provided] [unused] [could be renamed] */
/*! export __RouterContext [provided] [used in runtime] [could be renamed] */
/*! export generatePath [provided] [unused] [could be renamed] */
/*! export matchPath [provided] [used in runtime] [could be renamed] */
...
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ 41788);
...
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! history */ 59731);
/* harmony import */ var tiny_warning__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tiny-warning */ 45298);
/* harmony import */ var mini_create_react_context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! mini-create-react-context */ 24523);
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tiny-invariant */ 2177);
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @babel/runtime/helpers/esm/extends */ 22122);
/* harmony import */ var path_to_regexp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! path-to-regexp */ 39658);
...
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-is */ 59864);
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_is__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @babel/runtime/helpers/esm/objectWithoutPropertiesLoose */ 19756);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_0__.createElement(historyContext.Provider, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Router, {
...
if (true) {
  MemoryRouter.propTypes = {
    initialEntries: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().array),
    initialIndex: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
    getUserConfirmation: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
    keyLength: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
    children: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().node)
  };
...
function Prompt(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Consumer, null, function (context) {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Lifecycle, {
...
if (true) {
  var messageType = prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)]);
  Prompt.propTypes = {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Consumer, null, function (context$1) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Provider, {
        value: props
      }, props.match ? children ? typeof children === "function" ?  true ? evalChildrenDev(children, props, _this.props.path) : 0 : children : component ? react__WEBPACK_IMPORTED_MODULE_0__.createElement(component, props) : render ? render(props) : null : typeof children === "function" ?  true ? evalChildrenDev(children, props, _this.props.path) : 0 : null);
    });
  };
...
if (true) {
  Route.propTypes = {
    children: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().func), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().node)]),
    ...
    path: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().string), prop_types__WEBPACK_IMPORTED_MODULE_1___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_1___default().string))]),
    render: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
    sensitive: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Router, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_10__.default)({}, rest, {
      history: history,
...
if (true) {
  StaticRouter.propTypes = {
    basename: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string),
    context: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().object),
    location: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().object)])
  };
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Consumer, null, function (context) {
      ...
      react__WEBPACK_IMPORTED_MODULE_0__.Children.forEach(_this.props.children, function (child) {
        if (match == null && react__WEBPACK_IMPORTED_MODULE_0__.isValidElement(child)) {
          element = child;
      ...
      return match ? react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(element, {
        location: location,
        computedMatch: match
      }) : null;
    });
...
function withRouter(Component) {
  ...
  var C = function C(props) {
    ...
    return React.createElement(context.Consumer, null, function (context) {
      !context ?  true ? invariant(false, "You should not use <" + displayName + " /> outside a <Router>") : 0 : void 0;
...
function useHistory() {
  if (true) {
    !(typeof useContext === "function") ?  true ? invariant(false, "You must use React >= 16.8 in order to use useHistory()") : 0 : void 0;
  }
...
function useLocation() {
  if (true) {
    !(typeof useContext === "function") ?  true ? invariant(false, "You must use React >= 16.8 in order to use useLocation()") : 0 : void 0;
  }
...
function useParams() {
  if (true) {
    !(typeof useContext === "function") ?  true ? invariant(false, "You must use React >= 16.8 in order to use useParams()") : 0 : void 0;
  }
...
function useRouteMatch(path) {
  if (true) {
    !(typeof useContext === "function") ?  true ? invariant(false, "You must use React >= 16.8 in order to use useRouteMatch()") : 0 : void 0;
  }
