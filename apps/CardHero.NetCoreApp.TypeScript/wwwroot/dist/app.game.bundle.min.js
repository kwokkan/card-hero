            ...
            react_default.a.createElement(esm["b" /* DndProvider */], { backend: dist_esm["a" /* default */] },
                react_default.a.createElement("div", { className: "row" },
                    react_default.a.createElement("div", { className: "col-lg-3" },
                        react_default.a.createElement(GameDetailWidget, { game: game }),
                        react_default.a.createElement(GameHistoryWidget, { game: game })),
...
// CONCATENATED MODULE: ./ClientApp/components/game/GameSelectDeckModal.tsx



class GameSelectDeckModal_GameSelectDeckModal extends react["Component"] {
    constructor(props) {
        super(props);
        this.state = {
            canJoin: false
    ...
    onExited() {
        this.setState(GameSelectDeckModal_GameSelectDeckModal.defaultState);
    }
    render() {
        if (!this.props.game) {
            return null;
        ...
        return (react_default.a.createElement(Modal["a" /* default */], Object.assign({}, this.props, { onExited: () => this.onExited, centered: true }),
            react_default.a.createElement(Modal["a" /* default */].Header, { closeButton: true },
                react_default.a.createElement(Modal["a" /* default */].Title, null, "Join Game")),
                    ...
                    react_default.a.createElement("div", { className: "container" },
                        react_default.a.createElement("form", { className: "form auto-post" },
                            react_default.a.createElement("div", { className: "form-group" },
                                "Join game ",
                                react_default.a.createElement("strong", null, this.props.game.name),
                                "?"),
                            react_default.a.createElement("div", { className: "form-group" },
                                ...
                                react_default.a.createElement("select", { id: "mDeckId", className: "form-control", value: this.state.deckId, onChange: (e) => this.onSelectChange(Object(nameof["a" /* nameof */])('deckId'), e) },
                                    ...
                                    this.props.decks.map(x => react_default.a.createElement("option", { key: x.id, value: x.id }, x.name)))))))),
            react_default.a.createElement(Modal["a" /* default */].Footer, null,
                ...
                react_default.a.createElement("button", { type: "button", className: "btn btn-success", onClick: () => this.onJoined(), disabled: !this.state.canJoin }, "Join"))));
    }
}
GameSelectDeckModal_GameSelectDeckModal.defaultState = {
    deckId: undefined,
    canJoin: false
};
...
class GameList_GameList extends react["Component"] {
    constructor(props) {
        super(props);
        this.state = {
            modalShown: false
    ...
    async onGameJoined(props) {
        ...
        await GameService["a" /* default */].join(props.gameId, props.deckId);
    }
    render() {
                ...
                react_default.a.createElement("table", { className: "table table-striped" },
                    react_default.a.createElement("thead", { className: "thead-inverse" },
                        react_default.a.createElement("tr", null,
                            ...
                            react_default.a.createElement("th", null, "Type"),
                            react_default.a.createElement("th", null, "Start Time"),
                            user &&
                                react_default.a.createElement("td", null))),
                    react_default.a.createElement("tbody", null, this.props.games.map(g => react_default.a.createElement("tr", { key: g.id },
                        react_default.a.createElement("th", { scope: "row" },
                            react_default.a.createElement(react_router_dom["b" /* Link */], { to: '/' + g.id },
                                ...
                                ' ',
                                g.name)),
                        react_default.a.createElement("td", null, GameType["a" /* default */][g.type]),
                        react_default.a.createElement("td", null,
                            react_default.a.createElement(DateFormat["a" /* default */], { date: g.startTime })),
                        user &&
                            react_default.a.createElement("td", null,
                                g.canJoin &&
                                    react_default.a.createElement("button", { type: "button", className: "btn btn-success", onClick: () => this.selectGame(g) }, "Join"),
                                g.canPlay &&
                                    react_default.a.createElement("button", { type: "button", className: "btn btn-primary" }, "Play"))))))),
            react_default.a.createElement(GameSelectDeckModal_GameSelectDeckModal, { show: this.state.modalShown, game: this.state.selectedGame, decks: this.props.decks, onHide: () => this.onHide(), onJoined: (props) => this.onGameJoined(props) })));
    }
}
GameList_GameList.contextType = AccountContext["a" /* AccountContext */];
...
class GameSearch_GameSearch extends react["Component"] {
    ...
    render() {
        return (react_default.a.createElement(react["Fragment"], null,
            ...
            react_default.a.createElement(GameCreateModal_GameCreateModal, { show: this.state.modalShown, onCreated: (game) => this.onGameCreated(game), onHide: () => this.setState({ modalShown: false }), decks: this.props.decks })));
    }
}
...
class GameApp_GameApp extends react["Component"] {
    ...
    render() {
        return (react_default.a.createElement(Layout["a" /* default */], { sideContent: react_default.a.createElement(GameSearch_GameSearch, { decks: this.state.decks, onGamesPopulated: (x) => this.onGamesPopulated(x) }) },
            react_default.a.createElement(GameList_GameList, { games: this.state.games, decks: this.state.decks })));
    }
}
