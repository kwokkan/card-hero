...
var Button = __webpack_require__("mLQA");
    ...
    render() {
        return (react_default.a.createElement(Modal["a" /* default */], Object.assign({}, this.props, { onExited: () => this.onExited, centered: true }),
            ...
            react_default.a.createElement(Modal["a" /* default */].Footer, null,
                react_default.a.createElement(Button["a" /* default */], { onClick: this.props.onHide }, "Close"),
                react_default.a.createElement(Button["a" /* default */], { onClick: () => this.onCreated(), disabled: !this.state.canSave }, "OK"))));
    }
}
