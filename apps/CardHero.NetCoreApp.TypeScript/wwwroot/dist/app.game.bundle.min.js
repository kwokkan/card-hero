...
function GameUsersWidget(props) {
    ...
    const getCurrentGameUserId = (currentUser, users) => {
        if (currentUser) {
            return null;
        }
        if (!users) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card" },
        ...
        props.users && props.users.length > 0 ?
            (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", { className: "list-group list-group-flush", "data-current-game-user-id": currentGameUserId, "data-xxx": props.currentGameUserId }, props.users.map(x => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", { key: x.id, className: 'list-group-item' + (props.currentGameUserId === x.id ? ' current' : '') + (user && user.id === x.userId ? ' you' : '') },
