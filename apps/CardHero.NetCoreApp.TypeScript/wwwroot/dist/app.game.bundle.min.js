...
const GameTripleTriadBoardGrid = (props) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { ref: drop, className: 'game-card' + (props.isSelected ? ' selected' : '') + (isOver ? ' bg-primary' : ''), "data-row": props.row, "data-column": props.column }, props.card &&
