...
class GameApp extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_Layout__WEBPACK_IMPORTED_MODULE_1__[/* Layout */ "a"], { sideContent: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameSearch__WEBPACK_IMPORTED_MODULE_3__[/* GameSearch */ "a"], { onGamesPopulated: (x) => this.onGamesPopulated(x) }) },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameList__WEBPACK_IMPORTED_MODULE_2__[/* GameList */ "a"], { games: this.state.games })));
    }
}
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("table", { className: "table table-striped" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, props.games.map(g => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", { key: g.id },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_DateFormat__WEBPACK_IMPORTED_MODULE_3__[/* DateFormat */ "a"], { date: g.startTime }))))))));
}
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__[/* BrowserRouter */ "a"], { basename: _shared_AppBootstrap__WEBPACK_IMPORTED_MODULE_3__[/* AppBootstrap */ "a"].url('Game') },
...
class GameSearch extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    async getGames(e) {
        ...
        var games = await _services_GameService__WEBPACK_IMPORTED_MODULE_3__[/* GameService */ "a"].getGames(this.state);
    ...
    async onGameCreated(game) {
        ...
        await _services_GameService__WEBPACK_IMPORTED_MODULE_3__[/* GameService */ "a"].createGame(postGame);
        await this.getGames();
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameCreateModal__WEBPACK_IMPORTED_MODULE_5__[/* GameCreateModal */ "a"], { show: this.state.modalShown, onCreated: (game) => this.onGameCreated(game), onHide: () => this.setState({ modalShown: false }), decks: this.state.decks })));
    }
}
...
function GameDeckCard(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { ref: drag, className: 'current-card' + (isUsable ? '' : ' bg-secondary text-white disabled') + (isDragging ? ' bg-primary' : ''), "data-card-collection-id": dc.cardCollectionId },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_CardWidget__WEBPACK_IMPORTED_MODULE_2__[/* CardWidget */ "a"], { card: dc })));
}
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-body" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "card-text" }, props.deck ?
                (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { id: "current-deck", className: "ch-cards", "data-max-cards": props.deck.maxCards }, props.deck.cards.map(x => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameDeckCard__WEBPACK_IMPORTED_MODULE_1__[/* GameDeckCard */ "a"], { key: x.id, card: x }))))
                :
    ...
    getGameGrid() {
        ...
        for (var i = 0; i < data.rows; i++) {
            ...
            for (var j = 0; j < data.columns; j++) {
                ...
                grids.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameTripleTriadBoardGrid__WEBPACK_IMPORTED_MODULE_3__[/* GameTripleTriadBoardGrid */ "a"], { key: key, row: i, column: j, card: card, isSelected: this.isSelected(i, j), onDrop: (x) => this.onCardDropped(x) }));
            }
        }
        return grids;
    }
...
class Game extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    async populateGame(id) {
        const game = await _services_GameService__WEBPACK_IMPORTED_MODULE_3__[/* GameService */ "a"].getGameById(id);
        if (game) {
            this.setState({
                game: game,
                deck: game.deck
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_Layout__WEBPACK_IMPORTED_MODULE_4__[/* Layout */ "a"], null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_dnd__WEBPACK_IMPORTED_MODULE_1__[/* DndProvider */ "b"], { backend: react_dnd_html5_backend__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"] },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col-lg-6" },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameBoard__WEBPACK_IMPORTED_MODULE_5__[/* GameBoard */ "a"], { game: game })),
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col-lg-3" },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameDeckWidget__WEBPACK_IMPORTED_MODULE_6__[/* GameDeckWidget */ "a"], { deck: this.state.deck }))))));
    }
}
    ...
    getGameBoard() {
        ...
        switch (this.props.game.type) {
            case _clients_clients__WEBPACK_IMPORTED_MODULE_1__[/* GameType */ "i"].TripleTriad:
                return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_tripletriad_GameTripleTriadBoard__WEBPACK_IMPORTED_MODULE_2__[/* GameTripleTriadBoard */ "a"], { game: this.props.game });
            default:
                return GameBoard.nullGameBoard;
        }
    }
