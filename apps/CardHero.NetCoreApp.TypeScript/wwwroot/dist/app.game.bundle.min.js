...
class GameSearch extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    ...
    async onGameCreated(game) {
        ...
        await _services_GameService__WEBPACK_IMPORTED_MODULE_2__["default"].createGame(postGame);
        await this.getGames();
    }
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GameCreateModal__WEBPACK_IMPORTED_MODULE_4__["default"], { show: this.state.modalShown, onCreated: (game) => this.onGameCreated(game), onHide: () => this.setState({ modalShown: false }), decks: this.props.decks })));
    }
}
