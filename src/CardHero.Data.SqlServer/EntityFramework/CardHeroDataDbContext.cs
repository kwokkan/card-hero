...
public partial class CardHeroDataDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Card>(entity =>
        {
            ...
            entity.Property(e => e.CardPackId).HasDefaultValueSql("((1))");
            ...
            entity.Property(e => e.Rowstamp)
                ...
                .IsRowVersion()
                .IsConcurrencyToken();
            entity.Property(e => e.TotalStats).HasComputedColumnSql("(isnull(((((([UpAttack]+[RightAttack])+[DownAttack])+[LeftAttack])+[Health])+[Attack])+[Defence],(0)))", false);

            entity.HasOne(d => d.CardPackFkNavigation).WithMany(p => p.Card)
                .HasForeignKey(d => d.CardPackFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Card_CardPack_FK");

            entity.HasOne(d => d.RarityFkNavigation).WithMany(p => p.Card)
        ...
        modelBuilder.Entity<CardCollection>(entity =>
        {
            ...
            entity.HasOne(d => d.CardFkNavigation).WithMany(p => p.CardCollection)
                .HasForeignKey(d => d.CardFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CardCollection_Card_FK");

            entity.HasOne(d => d.UserFkNavigation).WithMany(p => p.CardCollection)
        ...
        modelBuilder.Entity<CardFavourite>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.CardFk, e.UserFk }, "UX_CardFavourite_Card_FK_User_FK").IsUnique();

            entity.Property(e => e.CardFavouritePk).HasColumnName("CardFavourite_PK");
            entity.Property(e => e.CardFk).HasColumnName("Card_FK");
            entity.Property(e => e.UserFk).HasColumnName("User_FK");

            entity.HasOne(d => d.CardFkNavigation).WithMany(p => p.CardFavourite)
                .HasForeignKey(d => d.CardFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CardFavourite_Card_FK");

            entity.HasOne(d => d.UserFkNavigation).WithMany(p => p.CardFavourite)
                .HasForeignKey(d => d.UserFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CardPack>(entity =>
        {
            ...
            entity.Property(e => e.CardPackPk).HasColumnName("CardPack_PK");
            entity.Property(e => e.Description).HasMaxLength(1000);
            entity.Property(e => e.Name)
                .IsRequired()
                .HasMaxLength(100);
        ...
        modelBuilder.Entity<Deck>(entity =>
        {
            ...
            entity.HasOne(d => d.UserFkNavigation).WithMany(p => p.Deck)
                .HasForeignKey(d => d.UserFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<DeckCardCollection>(entity =>
        {
            ...
            entity.HasOne(d => d.CardCollectionFkNavigation).WithMany(p => p.DeckCardCollection)
                .HasForeignKey(d => d.CardCollectionFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DeckCardCollection_CardCollection_FK");

            entity.HasOne(d => d.DeckFkNavigation).WithMany(p => p.DeckCardCollection)
        ...
        modelBuilder.Entity<DeckFavourite>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DeckFk, e.UserFk }, "UX_DeckFavourite_Deck_FK_User_FK").IsUnique();

            entity.Property(e => e.DeckFavouritePk).HasColumnName("DeckFavourite_PK");
            entity.Property(e => e.DeckFk).HasColumnName("Deck_FK");
            entity.Property(e => e.UserFk).HasColumnName("User_FK");

            entity.HasOne(d => d.DeckFkNavigation).WithMany(p => p.DeckFavourite)
                .HasForeignKey(d => d.DeckFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DeckFavourite_Deck_FK");

            entity.HasOne(d => d.UserFkNavigation).WithMany(p => p.DeckFavourite)
                .HasForeignKey(d => d.UserFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Game>(entity =>
        {
            ...
            entity.HasOne(d => d.CurrentUserFkNavigation).WithMany(p => p.GameCurrentUserFkNavigation)
                .HasForeignKey(d => d.CurrentUserFk)
                .HasConstraintName("FK_Game_CurrentUser_FK");

            entity.HasOne(d => d.WinnerUserFkNavigation).WithMany(p => p.GameWinnerUserFkNavigation)
        ...
        modelBuilder.Entity<GameDeck>(entity =>
        {
            ...
            entity.HasOne(d => d.GameUserFkNavigation).WithMany(p => p.GameDeck)
        ...
        modelBuilder.Entity<GameDeckCardCollection>(entity =>
        {
            ...
            entity.HasOne(d => d.CardFkNavigation).WithMany(p => p.GameDeckCardCollection)
                .HasForeignKey(d => d.CardFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_GameDeckCardCollection_Card_FK");

            entity.HasOne(d => d.GameDeckFkNavigation).WithMany(p => p.GameDeckCardCollection)
        ...
        modelBuilder.Entity<GameUser>(entity =>
        {
            ...
            entity.HasOne(d => d.GameFkNavigation).WithMany(p => p.GameUser)
                .HasForeignKey(d => d.GameFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_GameUser_Game");

            entity.HasOne(d => d.UserFkNavigation).WithMany(p => p.GameUser)
                .HasForeignKey(d => d.UserFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Move>(entity =>
        {
            ...
            entity.HasOne(d => d.GameDeckCardCollectionFkNavigation).WithMany(p => p.Move)
                .HasForeignKey(d => d.GameDeckCardCollectionFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Move_CardCollection_FK");

            entity.HasOne(d => d.TurnFkNavigation).WithMany(p => p.Move)
        ...
        modelBuilder.Entity<StoreItem>(entity =>
        {
            ...
            entity.HasOne(d => d.CardPackFkNavigation).WithMany(p => p.StoreItem)
                .HasForeignKey(d => d.CardPackFk)
        ...
        modelBuilder.Entity<Turn>(entity =>
        {
            ...
            entity.HasOne(d => d.CurrentGameUserFkNavigation).WithMany(p => p.Turn)
                .HasForeignKey(d => d.CurrentGameUserFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Turn_CurrentGameUser_FK");

            entity.HasOne(d => d.GameFkNavigation).WithMany(p => p.Turn)
                .HasForeignKey(d => d.GameFk)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Identifier, e.IdPsource }, "UX_User_Identifier").IsUnique();
